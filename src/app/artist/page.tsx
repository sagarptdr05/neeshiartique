        ...
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-y-2 gap-x-4 text-xs font-semibold text-brand-cocoa/70 tracking-wide bg-brand-beige/20 py-2 px-6 rounded-full w-fit mx-auto border border-brand-beige/50">
            ...
            <span className="flex items-center space-x-1">
              ...
              <a href="mailto:neeshita.art27@gmail.com" className="hover:underline">neeshita.art27@gmail.com</a>
            </span>
            <span className="hidden sm:inline text-brand-cocoa/30">|</span>
      ...
      <main className="flex-grow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative aspect-[4/5] rounded-lg border border-brand-beige overflow-hidden shadow-md bg-brand-beige/10 group max-w-sm mx-auto w-full">
              <Image
                ...
                alt="Neeshita Prajapati"
                fill
                sizes="(max-width: 768px) 100vw, 33vw"
                className="object-cover transition-transform duration-500 group-hover:scale-105"
                priority
              />
              <div className="absolute bottom-4 right-4 bg-brand-cream/95 border border-brand-beige px-4 py-2.5 rounded text-center text-xs font-bold font-serif text-brand-cocoa shadow-sm">
                Neeshita • The Hands Behind the Yarn 🧶
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <div className="space-y-4">
                ...
                <p className="font-serif italic text-base text-brand-rose leading-relaxed">
                  "Turning little loops into beautiful, handmade creations—one stitch, one idea, and one piece of love at a time. 💕"
                </p>
              </div>
              <div className="w-12 h-[1px] bg-brand-rose/55 mx-auto lg:mx-0" />
              <p className="text-sm text-brand-cocoa/85 leading-relaxed">
                Welcome to my creative space. Neeshiartique is where my love for design, hands-on crafting, and thoughtful gifting all come together. Every piece in this boutique is crafted personally by me, loop by loop, from my workspace in Mumbai.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-16">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-brand-cocoa/80 leading-relaxed pl-6">
                Art has been a part of me since childhood. I’ve always loved creating things and expressing ideas through creativity. Over time, that love for making things slowly found its way into crochet.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 pl-6 text-sm text-brand-cocoa/80 leading-relaxed">
                <p>
                  It was during my second year of engineering that I slowly started getting interested in crochet. Amidst formulas and computer screens, I wanted to find a tactile, calming outlet to channel my childhood interest in art.
                </p>
                <div className="bg-brand-cream border border-brand-beige/60 rounded p-4 flex items-start space-x-3.5 mt-2">
                  ...
                  <p className="text-xs text-brand-cocoa/75">
                    I began learning crochet patterns through YouTube videos, trying different stitches, learning little by little, and slowly discovering how much I enjoyed turning a simple strand of yarn into something real. 🧶
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-brand-cocoa/80 leading-relaxed pl-6">
                One of the things that inspired me was simply wanting to make a special gift for my best friend. Making something with my own hands felt different. It wasn't just a gift — it carried time, effort and a little piece of me. That feeling made me realize how special handmade gifts can be, and I wanted to create pieces that could make someone else feel the same way.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 pl-6 text-sm text-brand-cocoa/80 leading-relaxed">
                <p className="italic font-medium text-brand-rose">
                  And how did Neeshiartique actually begin? Honestly... bas aise hi decide ho gaya ChatGPT se. 😂
                </p>
                <p>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-24 space-y-16">
          ...
          <div className="bg-brand-rose text-brand-cream rounded-lg p-6 sm:p-8 text-center space-y-3.5 shadow-md max-w-2xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-brand-cream/90 leading-relaxed">
              I especially love crocheting keychains and bouquets because they can make people feel special. They're little creations, but sometimes the smallest gifts can carry the biggest feelings. ♡
            </p>
          </div>
        ...
        <section className="bg-brand-beige/10 border-t border-b border-brand-beige/30 py-16 sm:py-24 space-y-16">
          ...
          <div className="max-w-3xl mx-auto px-4 space-y-4 text-center">
            ...
            <p className="text-sm text-brand-cocoa/85 leading-relaxed max-w-xl mx-auto">
              Crochet takes time. Every stitch is made by hand, and every piece needs patience. But even when a creation takes longer than expected, I still want to make it with love for the person who will receive it. The time that goes into a handmade piece is part of what makes it special.
            </p>
          </div>
        ...
        <section className="max-w-4xl mx-auto px-4 py-16 sm:py-24 space-y-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 text-center">
            ...
            <div className="bg-brand-offwhite border border-brand-beige/50 p-4 rounded space-y-1 shadow-sm">
              <span className="text-lg font-serif font-bold text-brand-rose block">01</span>
              <h4 className="text-xs font-bold text-brand-cocoa uppercase tracking-wide">Inspiration</h4>
              <p className="text-[10px] text-brand-cocoa/70 font-medium">A thought, a person or a special occasion.</p>
            </div>

            <div className="bg-brand-offwhite border border-brand-beige/50 p-4 rounded space-y-1 shadow-sm">
              <span className="text-lg font-serif font-bold text-brand-rose block">02</span>
              <h4 className="text-xs font-bold text-brand-cocoa uppercase tracking-wide">Choosing Idea</h4>
              <p className="text-[10px] text-brand-cocoa/70 font-medium">Deciding what custom piece to create.</p>
            </div>

            <div className="bg-brand-offwhite border border-brand-beige/50 p-4 rounded space-y-1 shadow-sm">
              <span className="text-lg font-serif font-bold text-brand-rose block">03</span>
              <h4 className="text-xs font-bold text-brand-cocoa uppercase tracking-wide">Exploring</h4>
              <p className="text-[10px] text-brand-cocoa/70 font-medium">Trying patterns, stitches, and combinations.</p>
            </div>

            <div className="bg-brand-offwhite border border-brand-beige/50 p-4 rounded space-y-1 shadow-sm">
              <span className="text-lg font-serif font-bold text-brand-rose block">04</span>
              <h4 className="text-xs font-bold text-brand-cocoa uppercase tracking-wide">Crocheting</h4>
              <p className="text-[10px] text-brand-cocoa/70 font-medium">Weaving yarn loops, one stitch at a time.</p>
            </div>

            <div className="bg-brand-offwhite border border-brand-beige/50 p-4 rounded space-y-1 shadow-sm">
              <span className="text-lg font-serif font-bold text-brand-rose block">05</span>
              <h4 className="text-xs font-bold text-brand-cocoa uppercase tracking-wide">Finishing</h4>
              <p className="text-[10px] text-brand-cocoa/70 font-medium">Checking borders, tags, and small details.</p>
            </div>

            <div className="bg-brand-offwhite border border-brand-beige/50 p-4 rounded space-y-1 shadow-sm">
              <span className="text-lg font-serif font-bold text-brand-rose block">06</span>
              <h4 className="text-xs font-bold text-brand-cocoa uppercase tracking-wide">With Love</h4>
              <p className="text-[10px] text-brand-cocoa/70 font-medium">Ready to become someone's special gift.</p>
            </div>
        ...
        <section className="bg-brand-beige/15 border-t border-b border-brand-beige/35 py-16 sm:py-24">
          <div className="max-w-3xl mx-auto px-4 text-center space-y-4">
            ...
            <p className="text-sm text-brand-cocoa/80 leading-relaxed max-w-xl mx-auto">
              There are still so many things I want to learn and create. One day, I'd love to make crochet tops, handbags, bigger and bigger bouquets, and explore even more ambitious crochet ideas.
            </p>
        ...
        <section className="max-w-3xl mx-auto px-4 py-20 text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="font-serif text-lg sm:text-xl text-brand-cocoa italic max-w-xl mx-auto leading-relaxed">
              "Every piece I make takes a little time, a lot of patience and a whole lot of love. And knowing that something I created might become a special gift for someone makes every stitch worth it. 💕"
            </p>
            <div className="space-y-0.5 pt-4">
              ...
              <p className="font-serif italic text-brand-rose font-semibold text-base">— Neeshita</p>
            </div>
          </div>
